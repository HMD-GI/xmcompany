...
public class XmAiTools {
    ...
    public Map<String, Object> queryEmployeeList(int currentPage, int pageSize, EmployeeQueryDTO employeeQueryDTO) {
        Map<String, Object> resultMap = new HashMap<>();
        ...
        try {
            ...
            // 调用员工服务查询员工列表
            Result<page<EmployeeVO>> result = employeeService.getEmployeeList(currentPage, pageSize, employeeQueryDTO);
